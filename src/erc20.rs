...
impl<T: Erc20Params> Default for Erc20<T> {
    fn default() -> Self {
        unsafe {
            Self {
                balances: StorageMap::new(U256::from(0), u8::from(0)),
                allowances: StorageMap::new(U256::from(0), u8::from(0)),
                total_supply: StorageU256::new(U256::from(0), u8::from(0)),
                phantom: PhantomData,
            }
        }
    }
